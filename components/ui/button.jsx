...
const buttonVariants = cva(
  "inline-flex item-center justify-center whitespace-nowrap rounded-full text-base font-semibold ring-offset-white transition-colors",
  {
    variants: {
      ...
      size: {
        default: "h-[44px] px-6 flex items-center justify-center ",
        md: "h-[48px] px-6 flex items-center justify-center" ,
        lg: "h-[56px] px-8 text-sm uppercase tracking-[2px] flex items-center justify-center",
